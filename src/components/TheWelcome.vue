                        ...
                        <div class="row">
                          <div class="col-md-6 col-xl-12">
                            ...
                            <div class="mb-3">
                              ...
                              <select type="text" class="form-select tomselected ts-hidden-accessible" id="select-states" value="" multiple="multiple" tabindex="-1">
                              ...
                              <option value="AZ" selected="">Arizona</option><option value="SC" selected="">South Carolina</option><option value="WY" selected="">Wyoming</option></select><div class="ts-wrapper form-select multi has-items"><div class="ts-control"><div data-value="AZ" class="item" data-ts-item="">Arizona</div><div data-value="SC" class="item" data-ts-item="">South Carolina</div><div data-value="WY" class="item last-active" data-ts-item="">Wyoming</div><input tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-states-ts-dropdown" id="select-states-ts-control" type="select-multiple"></div></div>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-6 col-xl-12">
                          ...
                          <div class="mb-3">
                            ...
                            <div class="input-group input-group-flat">
                              <input type="text" class="form-control" autocomplete="off">
                              <span class="input-group-text">
                                <a href="#" class="link-secondary" data-bs-toggle="tooltip" aria-label="Clear search" data-bs-original-title="Clear search"><!-- Download SVG icon from http://tabler-icons.io/i/x -->
                                  <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M18 6l-12 12"></path><path d="M6 6l12 12"></path></svg>
                                </a>
                                <a href="#" class="link-secondary ms-2" data-bs-toggle="tooltip" aria-label="Search settings" data-bs-original-title="Search settings"><!-- Download SVG icon from http://tabler-icons.io/i/adjustments -->
                                ...
                                <a href="#" class="link-secondary ms-2 disabled" data-bs-toggle="tooltip" aria-label="Add notification" data-bs-original-title="Add notification"><!-- Download SVG icon from http://tabler-icons.io/i/bell -->
                            ...
                            <div class="form-selectgroup">
                              ...
                              <label class="form-selectgroup-item">
                                ...
                                <span class="form-selectgroup-label"><!-- Download SVG icon from http://tabler-icons.io/i/circle -->
                                  <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"></path></svg>
                                  Circle</span>
                              </label>
                              <label class="form-selectgroup-item">
                          ...
                          <div class="mb-3">
                            ...
                            <div class="btn-group w-100" role="group">
                              ...
                              <label for="btn-radio-toolbar-2" class="btn btn-icon"><!-- Download SVG icon from http://tabler-icons.io/i/italic -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M11 5l6 0"></path><path d="M7 19l6 0"></path><path d="M14 5l-4 14"></path></svg>
                              </label>
                              ...
                              <label for="btn-radio-toolbar-5" class="btn btn-icon"><!-- Download SVG icon from http://tabler-icons.io/i/scissors -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M6 7m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0"></path><path d="M6 17m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0"></path><path d="M8.6 8.6l10.4 10.4"></path><path d="M8.6 15.4l10.4 -10.4"></path></svg>
                              </label>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-xl-12">
                          ...
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" data-bs-toggle="autosize" placeholder="Type something…" style="overflow: hidden; overflow-wrap: break-word; resize: none; text-align: start; height: 60px;"></textarea>
                          </div>
                        </div>
                        <div class="col-md-6 col-xl-12">
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <div class="datepicker-inline" id="datepicker-inline"><div class="litepicker" data-plugins="" style="display: inline-block; position: relative;"><div class="container__main"><div class="container__months"><div class="month-item"><div class="month-item-header"><button type="button" class="button-previous-month"><!-- Download SVG icon from http://tabler-icons.io/i/chevron-left -->
    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M15 6l-6 6l6 6"></path></svg></button><div><strong class="month-item-name">June</strong><span class="month-item-year">2024</span></div><button type="button" class="button-next-month"><!-- Download SVG icon from http://tabler-icons.io/i/chevron-right -->
    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M9 6l6 6l-6 6"></path></svg></button></div><div class="month-item-weekdays-row"><div title="Monday">Mon</div><div title="Tuesday">Tue</div><div title="Wednesday">Wed</div><div title="Thursday">Thu</div><div title="Friday">Fri</div><div title="Saturday">Sat</div><div title="Sunday">Sun</div></div><div class="container__days"><div></div><div></div><div></div><div></div><div></div><div class="day-item" data-time="1717210800000" tabindex="0">1</div><div class="day-item" data-time="1717297200000" tabindex="0">2</div><div class="day-item" data-time="1717383600000" tabindex="0">3</div><div class="day-item" data-time="1717470000000" tabindex="0">4</div><div class="day-item" data-time="1717556400000" tabindex="0">5</div><div class="day-item" data-time="1717642800000" tabindex="0">6</div><div class="day-item" data-time="1717729200000" tabindex="0">7</div><div class="day-item" data-time="1717815600000" tabindex="0">8</div><div class="day-item" data-time="1717902000000" tabindex="0">9</div><div class="day-item" data-time="1717988400000" tabindex="0">10</div><div class="day-item" data-time="1718074800000" tabindex="0">11</div><div class="day-item" data-time="1718161200000" tabindex="0">12</div><div class="day-item" data-time="1718247600000" tabindex="0">13</div><div class="day-item" data-time="1718334000000" tabindex="0">14</div><div class="day-item" data-time="1718420400000" tabindex="0">15</div><div class="day-item" data-time="1718506800000" tabindex="0">16</div><div class="day-item" data-time="1718593200000" tabindex="0">17</div><div class="day-item" data-time="1718679600000" tabindex="0">18</div><div class="day-item is-today" data-time="1718766000000" tabindex="0">19</div><div class="day-item" data-time="1718852400000" tabindex="0">20</div><div class="day-item" data-time="1718938800000" tabindex="0">21</div><div class="day-item" data-time="1719025200000" tabindex="0">22</div><div class="day-item" data-time="1719111600000" tabindex="0">23</div><div class="day-item" data-time="1719198000000" tabindex="0">24</div><div class="day-item" data-time="1719284400000" tabindex="0">25</div><div class="day-item" data-time="1719370800000" tabindex="0">26</div><div class="day-item" data-time="1719457200000" tabindex="0">27</div><div class="day-item" data-time="1719543600000" tabindex="0">28</div><div class="day-item" data-time="1719630000000" tabindex="0">29</div><div class="day-item" data-time="1719716400000" tabindex="0">30</div></div></div></div></div><div class="container__tooltip"></div></div></div>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <select type="text" class="form-select tomselected ts-hidden-accessible" id="select-users" value="" tabindex="-1">
                              
                              <option value="2">Elon Musk</option>
                              <option value="3">Paweł Kuna</option>
                              <option value="4">Nikola Tesla</option>
                            <option value="1">Chuck Tesla</option></select><div class="ts-wrapper form-select single input-hidden full has-items"><div class="ts-control"><div data-value="1" class="item" data-ts-item="">Chuck Tesla</div><input tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-users-ts-dropdown" id="select-users-ts-control" type="select-one"></div></div>
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Advanced select with optgroup</label>
                            <select type="text" class="form-select tomselected ts-hidden-accessible" id="select-optgroups" value="" tabindex="-1">
                              <optgroup label="Tags">
                            ...
                            <option value="HTML">HTML</option></select><div class="ts-wrapper form-select single input-hidden full has-items"><div class="ts-control"><div data-value="HTML" class="item" data-ts-item="">HTML</div><input tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-optgroups-ts-dropdown" id="select-optgroups-ts-control" type="select-one"></div></div>
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Select with avatars</label>
                            <select type="text" class="form-select tomselected ts-hidden-accessible" id="select-people" value="" tabindex="-1">
                            ...
                            <option value="1" data-custom-properties="<span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url(./static/avatars/000m.jpg)&quot;></span>">Paweł Kuna</option></select><div class="ts-wrapper form-select single input-hidden full has-items"><div class="ts-control"><div data-value="1" class="item" data-ts-item=""><span class="dropdown-item-indicator"><span class="avatar avatar-xs" style="background-image: url(./static/avatars/000m.jpg)"></span></span>Paweł Kuna</div><input tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-people-ts-dropdown" id="select-people-ts-control" type="select-one"></div></div>
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Select with flags</label>
                            <select type="text" class="form-select tomselected ts-hidden-accessible" id="select-countries" value="" tabindex="-1">
                            ...
                            <option value="pl" data-custom-properties="<span class=&quot;flag flag-xs flag-country-pl&quot;></span>">Poland</option></select><div class="ts-wrapper form-select single input-hidden full has-items"><div class="ts-control"><div data-value="pl" class="item" data-ts-item=""><span class="dropdown-item-indicator"><span class="flag flag-xs flag-country-pl"></span></span>Poland</div><input tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-countries-ts-dropdown" id="select-countries-ts-control" type="select-one"></div></div>
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Select with labels</label>
                            <select type="text" class="form-select tomselected ts-hidden-accessible" id="select-labels" value="" tabindex="-1">
                            ...
                            <option value="copy" data-custom-properties="<span class=&quot;badge bg-primary-lt&quot;>cmd + C</span>">Copy</option></select><div class="ts-wrapper form-select single input-hidden full has-items"><div class="ts-control"><div data-value="copy" class="item" data-ts-item=""><span class="dropdown-item-indicator"><span class="badge bg-primary-lt">cmd + C</span></span>Copy</div><input tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-labels-ts-dropdown" id="select-labels-ts-control" type="select-one"></div></div>
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Advanced select with validation state</label>
                            <select type="text" class="form-select mb-3 is-valid tomselected ts-hidden-accessible" id="select-countries-valid" value="" tabindex="-1">
                              
                              <option value="de">Germany</option>
                              <option value="cz">Czech Republic</option>
                              <option value="br">Brazil</option>
                            <option value="pl">Poland</option></select><div class="ts-wrapper form-select mb-3 is-valid single input-hidden full has-items"><div class="ts-control"><div data-value="pl" class="item" data-ts-item="">Poland</div><input tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-countries-valid-ts-dropdown" id="select-countries-valid-ts-control" type="select-one"></div></div>
                            <select type="text" class="form-select is-invalid tomselected ts-hidden-accessible" id="select-countries-invalid" value="" tabindex="-1">
                              
                              <option value="de">Germany</option>
                              <option value="cz">Czech Republic</option>
                              <option value="br">Brazil</option>
                            <option value="pl">Poland</option></select><div class="ts-wrapper form-select is-invalid single input-hidden full has-items"><div class="ts-control"><div data-value="pl" class="item" data-ts-item="">Poland</div><input tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-countries-invalid-ts-dropdown" id="select-countries-invalid-ts-control" type="select-one"></div></div>
                          </div>
                        </div>
                      </div>
                    </div>
